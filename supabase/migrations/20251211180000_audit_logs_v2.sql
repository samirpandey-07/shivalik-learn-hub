...
-- Remove old trigger if it exists from previous manual runs
DROP TRIGGER IF EXISTS audit_communities_trigger ON public.communities;
DROP TRIGGER IF EXISTS on_community_change ON public.communities; -- Drop potential old one from previous migration
