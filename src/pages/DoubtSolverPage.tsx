...
import { Loader2, Upload, Image as ImageIcon, Send, X, AlertTriangle, Coins, Sparkles, Play } from "lucide-react";
...
export default function DoubtSolverPage() {
    ...
    const handleSolve = async () => {
        ...
        try {
            ...
            // Hackathon Mode: Allow proceeding even if transaction fails (e.g. offline)
            toast.message("Offline Mode Active", { description: "Proceeding without coin deduction." });
        }

        try {
            // Use the new unified solver
                        ...
                        {loading ? (
                            ...
                            <div className="prose prose-sm dark:prose-invert max-w-none animate-in fade-in slide-in-from-bottom-5 duration-500">
                                ...
                                <div className="mt-8 pt-4 border-t text-center">
                                    <p className="text-xs text-muted-foreground">Generated by Gemini 2.0 Vision</p>
                                </div>
                            </div>
                        ) : (
