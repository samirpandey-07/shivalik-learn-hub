...
export function LandingNavbar() {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 bg-background/10 backdrop-blur-md border-b border-white/5">
            <div
            ...
            <div className="flex items-center gap-4">
                <Button
                    variant="ghost"
                    className="text-white hover:text-primary hover:bg-white/5 hidden md:flex"
